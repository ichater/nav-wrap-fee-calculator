$(".info1 span").on("click", function(){
    alert("Investments marked with a # are owned by NAB which means they will not be subject to the .1% P/A fee")
});

$(".info2").on("click", function(){
    alert("All listed investments incur a fee of .15% P/A"
...
$(".info3").on("click", function(){
    alert("Managed funds are investments that are managed for you "
